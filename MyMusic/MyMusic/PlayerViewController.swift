...
class PlayerViewController: UIViewController {
    ...
    func configure() {
       ...
       // album cover
        albumImageView.frame = CGRect(x: 0,
                                      ...
                                      height: holder.frame.size.width)
        ...
        nextButton.setBackgroundImage(UIImage(systemName: "chevron.right.2"), for: .normal)
        backButton.setBackgroundImage(UIImage(systemName: "chevron.left.2"), for: .normal)
    ...
    @objc func didTapPlayPauseButton() {
        if player?.isPlaying == true {
            ...
            // increase image size
            UIView.animate(withDuration: 0.2, animations: {
                self.albumImageView.frame = CGRect(x: 0,
                                                   y: 0,
                                                   width: self.holder.frame.size.width,
                                                   height: self.holder.frame.size.width)
            })
        }
    }
